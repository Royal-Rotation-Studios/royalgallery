-- Addicte/localization/en-us.lua (CLEANED copy)
return {
    descriptions = {
        Joker = {
            j_sj_sample_wee = {
                ...
                text = {
                    {
                        ...
                        "{C:money}$#2#{}, else one random",
                        "{C:attention}Joker{} becomes {C:attention}Rental{}",
            ...
            j_sj_numerophobia = {
                ...
                text = {
                    {
                        "On first played {C:attention}hand{} of {C:attention}round{},",
                        "Convert all {C:attention}numbered{} cards into",
                        "random {C:attention}letter cards{}",
                    }
                },
            },
        }
